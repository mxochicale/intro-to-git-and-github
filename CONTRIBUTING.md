# Contributing to `intro-to-git-and-github`
...
## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/mxochicale/intro-to-git-and-github/issues/new 
